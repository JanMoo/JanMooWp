...
Donate link: http://bit.ly/nelio-featured-posts-donate
...
Posts](https://neliosoftware.com/blog/set-collection-featured-posts/) (Nelio's blog)
...
* Fixed compatibility issue with WordPress 4.4 (_Delete_ actions were not
visible).
