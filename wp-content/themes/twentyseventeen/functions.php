...
__('state of employment Widget', 'wpb_widget_domain'),

// Widget description
array( 'description' => __( 'widget that sets current state of employment', 'wpb_widget_domain' ), )
);
}
...
$employer = apply_filters( 'widget_title', $instance['title'] );
$title = 'current state of employment';
...
echo __( $employer, 'wpb_widget_domain' );
